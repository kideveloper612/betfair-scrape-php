<?php
@file_put_contents('/var/www/preit.nicoladefontetipster.com/preit_log.txt',  date("Y-m-d h:i:sa") . '\n');
...
function get_data_from_betfair() {
	...
	//  if ( !file_exists($dir) )
	//    mkdir ($dir, 0777);
//    @file_put_contents('/var/www/preit.nicoladefontetipster.com/betfairit-data.json', json_encode($finalData));
    @file_put_contents('F:/working/php/scrapping/precom.nicoladefontetipster.com/betfairit-data.json', json_encode($finalData));
